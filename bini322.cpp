...
int main(int argc, char **argv) {
    ...
    bini322::FastMatmul(A, B, C2, numsteps, 1e-4);
    ...
    std::cout << "(1, 1): " << MaxRelativeDiff(C11A, C11B) << std::endl;
    std::cout << "(2, 1): " << MaxRelativeDiff(C21A, C21B) << std::endl;
    std::cout << "(3, 1): " << MaxRelativeDiff(C31A, C31B) << std::endl;

    std::cout << "(1, 2): " << MaxRelativeDiff(C12A, C12B) << std::endl;
    std::cout << "(2, 2): " << MaxRelativeDiff(C22A, C22B) << std::endl;
    std::cout << "(3, 2): " << MaxRelativeDiff(C32A, C32B) << std::endl;
