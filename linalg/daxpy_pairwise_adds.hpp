#ifndef _ALL_DAXPY_ADDS_HPP_
#define _ALL_DAXPY_ADDS_HPP_

template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1,
         Scalar alpha1,
         Matrix<Scalar>& C) {
...
template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2,
    ...
    Add(A1, alpha1, C);
    UpdateAddDaxpy(A2, alpha2, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3,
    ...
    Add(A1, alpha1, C);
    UpdateAddDaxpy(A2, alpha2, C);
    UpdateAddDaxpy(A3, alpha3, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4,
    ...
    UpdateAddDaxpy(A2, alpha2, C);
    UpdateAddDaxpy(A3, alpha3, C);
    UpdateAddDaxpy(A4, alpha4, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5,
    ...
    UpdateAddDaxpy(A3, alpha3, C);
    UpdateAddDaxpy(A4, alpha4, C);
    UpdateAddDaxpy(A5, alpha5, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6,
    ...
    UpdateAddDaxpy(A4, alpha4, C);
    UpdateAddDaxpy(A5, alpha5, C);
    UpdateAddDaxpy(A6, alpha6, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7,
    ...
    UpdateAddDaxpy(A5, alpha5, C);
    UpdateAddDaxpy(A6, alpha6, C);
    UpdateAddDaxpy(A7, alpha7, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8,
    ...
    UpdateAddDaxpy(A6, alpha6, C);
    UpdateAddDaxpy(A7, alpha7, C);
    UpdateAddDaxpy(A8, alpha8, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9,
    ...
    UpdateAddDaxpy(A7, alpha7, C);
    UpdateAddDaxpy(A8, alpha8, C);
    UpdateAddDaxpy(A9, alpha9, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10,
    ...
    UpdateAddDaxpy(A8, alpha8, C);
    UpdateAddDaxpy(A9, alpha9, C);
    UpdateAddDaxpy(A10, alpha10, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11,
    ...
    UpdateAddDaxpy(A9, alpha9, C);
    UpdateAddDaxpy(A10, alpha10, C);
    UpdateAddDaxpy(A11, alpha11, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11, Matrix<Scalar>& A12,
    ...
    UpdateAddDaxpy(A10, alpha10, C);
    UpdateAddDaxpy(A11, alpha11, C);
    UpdateAddDaxpy(A12, alpha12, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11, Matrix<Scalar>& A12, Matrix<Scalar>& A13,
    ...
    UpdateAddDaxpy(A11, alpha11, C);
    UpdateAddDaxpy(A12, alpha12, C);
    UpdateAddDaxpy(A13, alpha13, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11, Matrix<Scalar>& A12, Matrix<Scalar>& A13, Matrix<Scalar>& A14,
    ...
    UpdateAddDaxpy(A12, alpha12, C);
    UpdateAddDaxpy(A13, alpha13, C);
    UpdateAddDaxpy(A14, alpha14, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11, Matrix<Scalar>& A12, Matrix<Scalar>& A13, Matrix<Scalar>& A14, Matrix<Scalar>& A15,
    ...
    UpdateAddDaxpy(A13, alpha13, C);
    UpdateAddDaxpy(A14, alpha14, C);
    UpdateAddDaxpy(A15, alpha15, C);
}


template <typename Scalar>
void DaxpyAdd(Matrix<Scalar>& A1, Matrix<Scalar>& A2, Matrix<Scalar>& A3, Matrix<Scalar>& A4, Matrix<Scalar>& A5, Matrix<Scalar>& A6, Matrix<Scalar>& A7, Matrix<Scalar>& A8, Matrix<Scalar>& A9, Matrix<Scalar>& A10, Matrix<Scalar>& A11, Matrix<Scalar>& A12, Matrix<Scalar>& A13, Matrix<Scalar>& A14, Matrix<Scalar>& A15, Matrix<Scalar>& A16,
