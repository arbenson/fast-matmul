...
# endif
    ...
    // M5 = (1 * A11 + -1 * A12 + -1 * A21 + 1 * A22) * (1 * B12)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M12 = (-1 * A12 + -1 * A13 + 1 * A22) * (1 * B12 + 1 * B22)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M14 = (-1 * A12 + -1 * A13 + -1 * A21 + 1 * A22) * (-1 * B12 + 1 * B21)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
