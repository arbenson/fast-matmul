...
# pragma omp task
    ...
    FastMatmulRecursive(S9, B23, M9, numsteps - 1, x);
    S9.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(S11, B14, M11, numsteps - 1, x);
    S11.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    {
#endif
    FastMatmulRecursive(A32, B21, M15, numsteps - 1, x);
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
    }
...
# pragma omp task
    ...
    FastMatmulRecursive(S17, B12, M17, numsteps - 1, x);
    S17.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
