...
# pragma omp task
    ...
    Add(A11, A21, Scalar(-1.0), Scalar(1.0), S1);
...
# pragma omp task
    ...
    Add(A21, A22, A31, Scalar(-1.0), Scalar(1.0), Scalar(1.0), S4);
    Matrix<Scalar> T4(B11.m(), B11.n());
    Add(B14, B21, B24, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T4);
...
# pragma omp task
    ...
    Add(A21, A22, A31, A32, Scalar(-1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), S5);
    Matrix<Scalar> T5(B11.m(), B11.n());
    Add(B21, B24, Scalar(1.0), Scalar(1.0), T5);
...
# pragma omp task
    ...
    Add(B14, B23, Scalar(-1.0), Scalar(1.0), T6);
...
# pragma omp task
    ...
    Add(A12, A22, A32, Scalar(1.0), Scalar(-1.0), Scalar(1.0), S7);
    Matrix<Scalar> T7(B11.m(), B11.n());
    Add(B12, B22, Scalar(-1.0), Scalar(-1.0), T7);
...
# pragma omp task
    ...
    Add(B14, B24, Scalar(1.0), Scalar(1.0), T10);
...
# pragma omp task
    ...
    Add(A21, A22, Scalar(-1.0), Scalar(1.0), S11);
...
# pragma omp task
    ...
    Add(A11, A12, A22, A32, Scalar(-1.0), Scalar(1.0), Scalar(-1.0), Scalar(1.0), S12);
    Matrix<Scalar> T12(B11.m(), B11.n());
    Add(B12, B23, Scalar(1.0), Scalar(-1.0), T12);
...
# pragma omp task
    ...
    Add(A12, A22, Scalar(1.0), Scalar(1.0), S13);
    Matrix<Scalar> T13(B11.m(), B11.n());
    Add(B23, B24, Scalar(1.0), Scalar(1.0), T13);
...
# pragma omp task
    ...
    Add(B13, B23, Scalar(1.0), Scalar(1.0), T14);
...
# pragma omp task
    ...
    Add(A11, A21, Scalar(-1.0), Scalar(-1.0), S16);
    Matrix<Scalar> T16(B11.m(), B11.n());
    Add(B13, B14, Scalar(-1.0), Scalar(-1.0), T16);
...
# pragma omp task
    ...
    Add(A11, A12, A21, A22, A31, A32, Scalar(-1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), Scalar(-1.0), Scalar(1.0), S17);
...
# pragma omp task
    ...
    Add(A11, A12, A21, A22, A32, Scalar(1.0), Scalar(-1.0), Scalar(-1.0), Scalar(1.0), Scalar(-1.0), S18);
...
# pragma omp task
    ...
    Add(A21, A31, Scalar(-1.0), Scalar(1.0), S19);
    Matrix<Scalar> T19(B11.m(), B11.n());
    Add(B11, B14, B21, B24, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T19);
...
# pragma omp task
    ...
    Add(B21, B22, Scalar(-1.0), Scalar(-1.0), T20);
