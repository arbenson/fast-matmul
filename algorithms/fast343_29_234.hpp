...
# pragma omp task if(sequential1) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A11, T1, M1, total_steps, steps_left - 1, (start_index + 1 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential2) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A12, T2, M2, total_steps, steps_left - 1, (start_index + 2 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential3) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S3, T3, M3, total_steps, steps_left - 1, (start_index + 3 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential4) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A14, T4, M4, total_steps, steps_left - 1, (start_index + 4 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential5) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A21, T5, M5, total_steps, steps_left - 1, (start_index + 5 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential6) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S6, T6, M6, total_steps, steps_left - 1, (start_index + 6 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential7) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S7, B41, M7, total_steps, steps_left - 1, (start_index + 7 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential8) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S8, B12, M8, total_steps, steps_left - 1, (start_index + 8 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential9) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S9, T9, M9, total_steps, steps_left - 1, (start_index + 9 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential10) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S10, T10, M10, total_steps, steps_left - 1, (start_index + 10 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential11) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S11, T11, M11, total_steps, steps_left - 1, (start_index + 11 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential12) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S12, T12, M12, total_steps, steps_left - 1, (start_index + 12 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential13) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S13, T13, M13, total_steps, steps_left - 1, (start_index + 13 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential14) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S14, T14, M14, total_steps, steps_left - 1, (start_index + 14 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential15) shared(mem_mngr) untied
    {
#endif
    FastMatmulRecursive(mem_mngr, A12, B21, M15, total_steps, steps_left - 1, (start_index + 15 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential16) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S16, T16, M16, total_steps, steps_left - 1, (start_index + 16 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential17) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A32, T17, M17, total_steps, steps_left - 1, (start_index + 17 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential18) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S18, T18, M18, total_steps, steps_left - 1, (start_index + 18 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential19) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S19, T19, M19, total_steps, steps_left - 1, (start_index + 19 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential20) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S20, B31, M20, total_steps, steps_left - 1, (start_index + 20 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential21) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S21, T21, M21, total_steps, steps_left - 1, (start_index + 21 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential22) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S22, T22, M22, total_steps, steps_left - 1, (start_index + 22 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential23) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A24, T23, M23, total_steps, steps_left - 1, (start_index + 23 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential24) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S24, T24, M24, total_steps, steps_left - 1, (start_index + 24 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential25) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A14, T25, M25, total_steps, steps_left - 1, (start_index + 25 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential26) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S26, T26, M26, total_steps, steps_left - 1, (start_index + 26 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential27) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S27, T27, M27, total_steps, steps_left - 1, (start_index + 27 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential28) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S28, T28, M28, total_steps, steps_left - 1, (start_index + 28 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential29) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S29, T29, M29, total_steps, steps_left - 1, (start_index + 29 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
