...
# pragma omp task
    ...
    Add(B11, B12, B13, Scalar(1.0), Scalar(1.0), Scalar(1.0), T3);
...
# pragma omp task
    ...
    Add(A14, A21, A24, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), S4);
    Matrix<Scalar> T4(B11.m(), B11.n());
    Add(B11, B12, B43, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T4);
...
# pragma omp task
    ...
    Add(A21, A24, Scalar(1.0), Scalar(1.0), S5);
...
# pragma omp task
    ...
    Add(A14, A23, Scalar(-1.0), Scalar(1.0), S6);
    Matrix<Scalar> T6(B11.m(), B11.n());
    Add(B32, B33, B41, Scalar(1.0), Scalar(1.0), Scalar(-1.0), T6);
...
# pragma omp task
    ...
    Add(B21, B22, B31, B33, B41, Scalar(1.0), Scalar(1.0), Scalar(-1.0), Scalar(1.0), Scalar(1.0), T9);
...
# pragma omp task
    ...
    Add(A14, A24, Scalar(1.0), Scalar(1.0), S10);
    Matrix<Scalar> T10(B11.m(), B11.n());
    Add(B11, B12, B41, B42, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), Scalar(1.0), T10);
...
# pragma omp task
    ...
    Add(B32, B33, B42, B43, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), Scalar(1.0), T11);
...
# pragma omp task
    ...
    Add(A12, A23, Scalar(1.0), Scalar(-1.0), S12);
    Matrix<Scalar> T12(B11.m(), B11.n());
    Add(B21, B22, B33, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T12);
...
# pragma omp task
    ...
    Add(A23, A24, Scalar(1.0), Scalar(1.0), S13);
...
# pragma omp task
    ...
    Add(A13, A23, Scalar(1.0), Scalar(1.0), S14);
    Matrix<Scalar> T14(B11.m(), B11.n());
    Add(B31, B32, B33, Scalar(-1.0), Scalar(1.0), Scalar(1.0), T14);
...
# pragma omp task
    ...
    Add(B11, B13, B22, B23, B43, Scalar(-1.0), Scalar(1.0), Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T15);
...
# pragma omp task
    ...
    Add(A13, A14, Scalar(-1.0), Scalar(-1.0), S16);
    Matrix<Scalar> T16(B11.m(), B11.n());
    Add(B32, B33, Scalar(1.0), Scalar(1.0), T16);
...
# pragma omp task
    ...
    Add(B11, B22, B23, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), T18);
...
# pragma omp task
    ...
    Add(A11, A14, A21, A24, Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), S19);
    Matrix<Scalar> T19(B11.m(), B11.n());
    Add(B11, B12, Scalar(1.0), Scalar(1.0), T19);
...
# pragma omp task
    ...
    Add(B22, B23, Scalar(1.0), Scalar(1.0), T20);
