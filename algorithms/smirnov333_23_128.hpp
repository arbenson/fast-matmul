...
# pragma omp task
    ...
    FastMatmulRecursive(A33, M1B, M1, numsteps - 1, x);
    M1B.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(A12, A32, A_X1, Scalar(1.0), Scalar(1.0), Scalar(1.0), M3A);
    FastMatmulRecursive(M3A, B23, M3, numsteps - 1, x);
    M3A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M4A, B_X1, M4, numsteps - 1, x);
    M4A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M5A, B12, M5, numsteps - 1, x);
    M5A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M7A, B11, M7, numsteps - 1, x);
    M7A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M8A, B11, M8, numsteps - 1, x);
    M8A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(B32, B_X2, Scalar(-1.0), Scalar(1.0), M9B);
    FastMatmulRecursive(A22, M9B, M9, numsteps - 1, x);
    M9B.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(B21, B_X2, Scalar(1.0), Scalar(-1.0), M10B);
...
# pragma omp task
    ...
    FastMatmulRecursive(M11A, B21, M11, numsteps - 1, x);
    M11A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(A13, A_X2, Scalar(-1.0), Scalar(1.0), M12A);
    Matrix<Scalar> M12B(B11.m(), B11.n());
    Add(B32, B_X3, Scalar(-1.0), Scalar(1.0), M12B);
...
# pragma omp task
    ...
    FastMatmulRecursive(A_X1, M14B, M14, numsteps - 1, x);
    M14B.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(B32, B33, B_X3, Scalar(1.0), Scalar(1.0), Scalar(-1.0), M16B);
...
# pragma omp task
    ...
    Add(A12, A13, A_X2, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), M17A);
    M17.UpdateMultiplier(Scalar(-1));
    FastMatmulRecursive(M17A, B_X3, M17, numsteps - 1, x);
    M17A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(A32, A_X1, Scalar(-1.0), Scalar(-1.0), M19A);
...
# pragma omp task
    ...
    FastMatmulRecursive(M20A, B33, M20, numsteps - 1, x);
    M20A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(B33, B_X1, Scalar(1.0), Scalar(-1.0), M21B);
    FastMatmulRecursive(A11, M21B, M21, numsteps - 1, x);
    M21B.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M22A, B12, M22, numsteps - 1, x);
    M22A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M23A, B21, M23, numsteps - 1, x);
    M23A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
    ...
    Add(M19, M21, Scalar(-1.0), Scalar(-1.0), M_X2);
    Matrix<Scalar> M_X3(C11.m(), C11.n());
    Add(M9, M22, Scalar(1.0), Scalar(-1.0), M_X3);


    Add(M1, M13, M15, M20, M23, Scalar(-1.0), Scalar(1.0), Scalar(-1.0), Scalar(1.0), Scalar(-1.0), C11);
    Add(M6, M12, M17, M19, M_X1, Scalar(1.0), Scalar(1.0), Scalar(1.0), Scalar(1.0), Scalar(1.0), C12);
    Add(M20, M_X1, M_X2, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), C13);
    Add(M1, M2, M6, M7, M18, Scalar(1.0), Scalar(-1.0), Scalar(1.0), Scalar(-1.0), Scalar(1.0), C21);
    Add(M6, M_X3, Scalar(1.0), Scalar(1.0), C22);
    Add(M4, M12, M16, M20, M21, M_X3, Scalar(1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), Scalar(-1.0), Scalar(-1.0), C23);
    ...
    Add(M5, M8, M14, M15, M_X2, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), C33);
