...
# pragma omp task
    ...
    S_Add4(A11, A21, S4, x);
    FastMatmulRecursive(S4, B_X1, M4, numsteps - 1, x);
    S4.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    {
#endif
    FastMatmulRecursive(A_X2, B32, M6, numsteps - 1, x);
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
    }
...
# pragma omp task
    ...
    FastMatmulRecursive(A_X1, T14, M14, numsteps - 1, x);
    T14.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(S17, B_X3, M17, numsteps - 1, x);
    S17.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp taskwait
    ...
    M_Add2(M6, M12, M17, M19, M_X1, C12, x);
    M_Add3(M20, M_X1, M_X2, C13, x);
    M_Add4(M1, M2, M6, M7, M18, C21, x);
    M_Add5(M6, M_X3, C22, x);
    M_Add6(M4, M12, M16, M20, M21, M_X3, C23, x);
    M_Add7(M1, M8, M11, C31, x);
    M_Add8(M2, M5, M9, M10, M11, C32, x);
    M_Add9(M5, M8, M14, M15, M_X2, C33, x);
