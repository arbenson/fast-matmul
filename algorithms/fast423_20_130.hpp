#ifndef _fast423_130_HPP_
#define _fast423_130_HPP_

// This is an automatically generated file from gen.py.
#include "common.hpp"

namespace fast423_130 {
...
#endif
    S_Add1(A31, A32, S1, x, sequential1);
...
#endif
    S_Add2(A31, A41, S2, x, sequential2);
...
# endif
    ...
    // M3 = (1 * A22 + -1 * A41) * (-1 * B12 + 1 * B13 + -1 * B21 + -1 * B23)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    T_Add4(B12, B22, T4, x, sequential4);
    M4.UpdateMultiplier(Scalar(1));
    FastMatmulRecursive(locker, mem_mngr, A11, T4, M4, total_steps, steps_left - 1, (start_index + 4 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T4.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    S_Add6(A21, A41, S6, x, sequential6);
#ifdef _PARALLEL_
...
# pragma omp task if(sequential7) shared(mem_mngr, locker) untied
    ...
    FastMatmulRecursive(locker, mem_mngr, S7, B22, M7, total_steps, steps_left - 1, (start_index + 7 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S7.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M8 = (1 * A41) * (1 * B11 + 1 * B13 + -1 * B21 + -1 * B23)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    T_Add8(B11, B13, B21, B23, T8, x, sequential8);
...
#endif
    S_Add9(A12, A32, S9, x, sequential9);
#ifdef _PARALLEL_
...
#endif
    T_Add10(B12, B13, T10, x, sequential10);
...
#endif
    S_Add11(A32, A42, S11, x, sequential11);
    M11.UpdateMultiplier(Scalar(1));
    FastMatmulRecursive(locker, mem_mngr, S11, B23, M11, total_steps, steps_left - 1, (start_index + 11 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S11.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M12 = (-1 * A11 + 1 * A22) * (-1 * B12 + 1 * B13 + 1 * B22)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M13 = (-1 * A32 + 1 * A41) * (1 * B11 + -1 * B21 + -1 * B23)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    T_Add15(B11, B21, T15, x, sequential15);
...
#endif
    S_Add16(A12, A22, S16, x, sequential16);
    M16.UpdateMultiplier(Scalar(1));
    FastMatmulRecursive(locker, mem_mngr, S16, B23, M16, total_steps, steps_left - 1, (start_index + 16 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S16.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M19 = (-1 * A22) * (-1 * B12 + 1 * B13 + 1 * B22 + -1 * B23)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    T_Add19(B12, B13, B22, B23, T19, x, sequential19);
    M19.UpdateMultiplier(Scalar(-1));
    FastMatmulRecursive(locker, mem_mngr, A22, T19, M19, total_steps, steps_left - 1, (start_index + 19 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T19.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
#endif
    S_Add20(A11, A21, S20, x, sequential20);
    M20.UpdateMultiplier(Scalar(1));
    FastMatmulRecursive(locker, mem_mngr, S20, B13, M20, total_steps, steps_left - 1, (start_index + 20 - 1) * 20, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S20.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp taskwait
    ...
    M_Add1(M5, M7, M9, M15, C11, x, false, beta);
    M_Add2(M4, M7, C12, x, false, beta);
    M_Add3(M4, M12, M16, M19, C13, x, false, beta);
    M_Add4(M3, M4, M6, M8, M10, M12, M19, M20, C21, x, false, beta);
    M_Add5(M4, M10, M12, M20, C22, x, false, beta);
    M_Add6(M4, M12, M19, M20, C23, x, false, beta);
    M_Add7(M1, M15, C31, x, false, beta);
    M_Add8(M1, M4, M5, M18, C32, x, false, beta);
    M_Add9(M2, M8, M13, M15, C33, x, false, beta);
    M_Add10(M11, M13, M14, M15, C41, x, false, beta);
    M_Add11(M3, M8, M11, M13, M14, M15, M17, M19, C42, x, false, beta);
    M_Add12(M8, M11, M13, M15, C43, x, false, beta);
