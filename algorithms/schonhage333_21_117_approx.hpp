...
template <typename Scalar>
void M_Add7(Matrix<Scalar>& M1, Matrix<Scalar>& M2, Matrix<Scalar>& M3, Matrix<Scalar>& M4, Matrix<Scalar>& M5, Matrix<Scalar>& C, double x=1e-8, Scalar beta=Scalar(0.0)) {
    const int strideM1 = M1.stride();
    const int strideM2 = M2.stride();
    const int strideM3 = M3.stride();
    const int strideM4 = M4.stride();
...
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 1, num_threads)) untied
    {
#endif
    ...
    T_Add1(B11, B21, T1, x);
    FastMatmulRecursive(S1, T1, M1, total_steps, steps_left - 1, (start_index + 1 - 1) * 21, x, num_threads, Scalar(0.0));
    S1.deallocate();
    T1.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 2, num_threads)) untied
    {
#endif
    ...
    T_Add2(B12, B21, T2, x);
    FastMatmulRecursive(S2, T2, M2, total_steps, steps_left - 1, (start_index + 2 - 1) * 21, x, num_threads, Scalar(0.0));
    S2.deallocate();
    T2.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 3, num_threads)) untied
    {
#endif
    ...
    T_Add3(B13, B21, T3, x);
    FastMatmulRecursive(S3, T3, M3, total_steps, steps_left - 1, (start_index + 3 - 1) * 21, x, num_threads, Scalar(0.0));
    S3.deallocate();
    T3.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 4, num_threads)) untied
    {
#endif
    ...
    T_Add4(B11, B22, T4, x);
    FastMatmulRecursive(S4, T4, M4, total_steps, steps_left - 1, (start_index + 4 - 1) * 21, x, num_threads, Scalar(0.0));
    S4.deallocate();
    T4.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 5, num_threads)) untied
    {
#endif
    ...
    T_Add5(B12, B22, T5, x);
    FastMatmulRecursive(S5, T5, M5, total_steps, steps_left - 1, (start_index + 5 - 1) * 21, x, num_threads, Scalar(0.0));
    S5.deallocate();
    T5.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 6, num_threads)) untied
    {
#endif
    ...
    T_Add6(B13, B22, T6, x);
    FastMatmulRecursive(S6, T6, M6, total_steps, steps_left - 1, (start_index + 6 - 1) * 21, x, num_threads, Scalar(0.0));
    S6.deallocate();
    T6.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 7, num_threads)) untied
    {
#endif
    ...
    T_Add7(B11, B23, T7, x);
    FastMatmulRecursive(S7, T7, M7, total_steps, steps_left - 1, (start_index + 7 - 1) * 21, x, num_threads, Scalar(0.0));
    S7.deallocate();
    T7.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 8, num_threads)) untied
    {
#endif
    ...
    T_Add8(B12, B23, T8, x);
    FastMatmulRecursive(S8, T8, M8, total_steps, steps_left - 1, (start_index + 8 - 1) * 21, x, num_threads, Scalar(0.0));
    S8.deallocate();
    T8.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 9, num_threads)) untied
    {
#endif
    ...
    T_Add9(B13, B23, T9, x);
    FastMatmulRecursive(S9, T9, M9, total_steps, steps_left - 1, (start_index + 9 - 1) * 21, x, num_threads, Scalar(0.0));
    S9.deallocate();
    T9.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 10, num_threads)) untied
    {
#endif
    Matrix<Scalar> S10(A11.m(), A11.n());
    S_Add10(A11, A13, S10, x);
    FastMatmulRecursive(S10, B31, M10, total_steps, steps_left - 1, (start_index + 10 - 1) * 21, x, num_threads, Scalar(0.0));
    S10.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 11, num_threads)) untied
    {
#endif
    Matrix<Scalar> S11(A11.m(), A11.n());
    S_Add11(A11, A23, S11, x);
    Matrix<Scalar> T11(B11.m(), B11.n());
    T_Add11(B12, B31, T11, x);
    FastMatmulRecursive(S11, T11, M11, total_steps, steps_left - 1, (start_index + 11 - 1) * 21, x, num_threads, Scalar(0.0));
    S11.deallocate();
    T11.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 12, num_threads)) untied
    {
#endif
    Matrix<Scalar> S12(A11.m(), A11.n());
    S_Add12(A11, A33, S12, x);
    Matrix<Scalar> T12(B11.m(), B11.n());
    T_Add12(B13, B31, T12, x);
    FastMatmulRecursive(S12, T12, M12, total_steps, steps_left - 1, (start_index + 12 - 1) * 21, x, num_threads, Scalar(0.0));
    S12.deallocate();
    T12.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 13, num_threads)) untied
    {
#endif
    Matrix<Scalar> S13(A11.m(), A11.n());
    S_Add13(A13, A21, S13, x);
    Matrix<Scalar> T13(B11.m(), B11.n());
    T_Add13(B11, B32, T13, x);
    FastMatmulRecursive(S13, T13, M13, total_steps, steps_left - 1, (start_index + 13 - 1) * 21, x, num_threads, Scalar(0.0));
    S13.deallocate();
    T13.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 14, num_threads)) untied
    {
#endif
    Matrix<Scalar> S14(A11.m(), A11.n());
    S_Add14(A21, A23, S14, x);
    FastMatmulRecursive(S14, B32, M14, total_steps, steps_left - 1, (start_index + 14 - 1) * 21, x, num_threads, Scalar(0.0));
    S14.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 15, num_threads)) untied
    {
#endif
    Matrix<Scalar> S15(A11.m(), A11.n());
    S_Add15(A21, A33, S15, x);
    Matrix<Scalar> T15(B11.m(), B11.n());
    T_Add15(B13, B32, T15, x);
    FastMatmulRecursive(S15, T15, M15, total_steps, steps_left - 1, (start_index + 15 - 1) * 21, x, num_threads, Scalar(0.0));
    S15.deallocate();
    T15.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 16, num_threads)) untied
    {
#endif
    Matrix<Scalar> S16(A11.m(), A11.n());
    S_Add16(A13, A31, S16, x);
    Matrix<Scalar> T16(B11.m(), B11.n());
    T_Add16(B11, B33, T16, x);
    FastMatmulRecursive(S16, T16, M16, total_steps, steps_left - 1, (start_index + 16 - 1) * 21, x, num_threads, Scalar(0.0));
    S16.deallocate();
    T16.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 17, num_threads)) untied
    {
#endif
    Matrix<Scalar> S17(A11.m(), A11.n());
    S_Add17(A23, A31, S17, x);
    Matrix<Scalar> T17(B11.m(), B11.n());
    T_Add17(B12, B33, T17, x);
    FastMatmulRecursive(S17, T17, M17, total_steps, steps_left - 1, (start_index + 17 - 1) * 21, x, num_threads, Scalar(0.0));
    S17.deallocate();
    T17.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 18, num_threads)) untied
    {
#endif
    Matrix<Scalar> S18(A11.m(), A11.n());
    S_Add18(A31, A33, S18, x);
    FastMatmulRecursive(S18, B33, M18, total_steps, steps_left - 1, (start_index + 18 - 1) * 21, x, num_threads, Scalar(0.0));
    S18.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 19, num_threads)) untied
    {
#endif
    Matrix<Scalar> T19(B11.m(), B11.n());
    T_Add19(B21, B31, T19, x);
    FastMatmulRecursive(A11, T19, M19, total_steps, steps_left - 1, (start_index + 19 - 1) * 21, x, num_threads, Scalar(0.0));
    T19.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 20, num_threads)) untied
    {
#endif
    Matrix<Scalar> T20(B11.m(), B11.n());
    T_Add20(B22, B32, T20, x);
    FastMatmulRecursive(A21, T20, M20, total_steps, steps_left - 1, (start_index + 20 - 1) * 21, x, num_threads, Scalar(0.0));
    T20.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
# pragma omp task if(should_launch_task(21, total_steps, steps_left, start_index, 21, num_threads)) untied
    {
#endif
    Matrix<Scalar> T21(B11.m(), B11.n());
    T_Add21(B23, B33, T21, x);
    FastMatmulRecursive(A31, T21, M21, total_steps, steps_left - 1, (start_index + 21 - 1) * 21, x, num_threads, Scalar(0.0));
    T21.deallocate();
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp taskwait
    ...
    M_Add1(M1, M10, M19, C11, x, beta);
    M_Add2(M4, M10, M11, M13, M20, C12, x, beta);
    M_Add3(M7, M10, M12, M16, M21, C13, x, beta);
    M_Add4(M2, M11, M13, M14, M19, C21, x, beta);
    M_Add5(M5, M14, M20, C22, x, beta);
    M_Add6(M8, M14, M15, M17, M21, C23, x, beta);
    M_Add7(M3, M12, M16, M18, M19, C31, x, beta);
    M_Add8(M6, M15, M17, M18, M20, C32, x, beta);
    M_Add9(M9, M18, M21, C33, x, beta);
