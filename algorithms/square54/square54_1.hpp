#ifndef _square54_1_HPP_
#define _square54_1_HPP_

// This is an automatically generated file from gen.py.
#include "common.hpp"

#include "square54_2.hpp"

namespace square54_1 {
...
# pragma omp task if(sequential1) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S1, T1, M1, steps_left - 1);
#ifndef _PARALLEL_
    S1.deallocate();
    T1.deallocate();
#endif
...
# pragma omp task if(sequential2) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S2, T2, M2, steps_left - 1);
#ifndef _PARALLEL_
    S2.deallocate();
    T2.deallocate();
#endif
...
# pragma omp task if(sequential3) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S3, T3, M3, steps_left - 1);
#ifndef _PARALLEL_
    S3.deallocate();
    T3.deallocate();
#endif
...
# pragma omp task if(sequential4) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S4, T4, M4, steps_left - 1);
#ifndef _PARALLEL_
    S4.deallocate();
    T4.deallocate();
#endif
...
# pragma omp task if(sequential5) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S5, T5, M5, steps_left - 1);
#ifndef _PARALLEL_
    S5.deallocate();
    T5.deallocate();
#endif
...
# pragma omp task if(sequential6) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S6, T6, M6, steps_left - 1);
#ifndef _PARALLEL_
    S6.deallocate();
    T6.deallocate();
#endif
...
# pragma omp task if(sequential7) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S7, T7, M7, steps_left - 1);
#ifndef _PARALLEL_
    S7.deallocate();
    T7.deallocate();
#endif
...
# pragma omp task if(sequential8) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S8, T8, M8, steps_left - 1);
#ifndef _PARALLEL_
    S8.deallocate();
    T8.deallocate();
#endif
...
# pragma omp task if(sequential9) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S9, T9, M9, steps_left - 1);
#ifndef _PARALLEL_
    S9.deallocate();
    T9.deallocate();
#endif
...
# pragma omp task if(sequential10) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S10, T10, M10, steps_left - 1);
#ifndef _PARALLEL_
    S10.deallocate();
    T10.deallocate();
#endif
...
# pragma omp task if(sequential11) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S11, T11, M11, steps_left - 1);
#ifndef _PARALLEL_
    S11.deallocate();
    T11.deallocate();
#endif
...
# pragma omp task if(sequential12) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S12, T12, M12, steps_left - 1);
#ifndef _PARALLEL_
    S12.deallocate();
    T12.deallocate();
#endif
...
# pragma omp task if(sequential13) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S13, T13, M13, steps_left - 1);
#ifndef _PARALLEL_
    S13.deallocate();
    T13.deallocate();
#endif
...
# pragma omp task if(sequential14) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S14, T14, M14, steps_left - 1);
#ifndef _PARALLEL_
    S14.deallocate();
    T14.deallocate();
#endif
...
# pragma omp task if(sequential15) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S15, T15, M15, steps_left - 1);
#ifndef _PARALLEL_
    S15.deallocate();
    T15.deallocate();
#endif
...
# pragma omp task if(sequential16) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S16, T16, M16, steps_left - 1);
#ifndef _PARALLEL_
    S16.deallocate();
    T16.deallocate();
#endif
...
# pragma omp task if(sequential17) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S17, T17, M17, steps_left - 1);
#ifndef _PARALLEL_
    S17.deallocate();
    T17.deallocate();
#endif
...
# pragma omp task if(sequential18) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S18, T18, M18, steps_left - 1);
#ifndef _PARALLEL_
    S18.deallocate();
    T18.deallocate();
#endif
...
# pragma omp task if(sequential19) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S19, T19, M19, steps_left - 1);
#ifndef _PARALLEL_
    S19.deallocate();
    T19.deallocate();
#endif
...
# pragma omp task if(sequential20) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S20, T20, M20, steps_left - 1);
#ifndef _PARALLEL_
    S20.deallocate();
    T20.deallocate();
#endif
...
# pragma omp task if(sequential21) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S21, T21, M21, steps_left - 1);
#ifndef _PARALLEL_
    S21.deallocate();
    T21.deallocate();
#endif
...
# pragma omp task if(sequential22) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S22, T22, M22, steps_left - 1);
#ifndef _PARALLEL_
    S22.deallocate();
    T22.deallocate();
#endif
...
# pragma omp task if(sequential23) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S23, T23, M23, steps_left - 1);
#ifndef _PARALLEL_
    S23.deallocate();
    T23.deallocate();
#endif
...
# pragma omp task if(sequential24) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S24, T24, M24, steps_left - 1);
#ifndef _PARALLEL_
    S24.deallocate();
    T24.deallocate();
#endif
...
# pragma omp task if(sequential25) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S25, T25, M25, steps_left - 1);
#ifndef _PARALLEL_
    S25.deallocate();
    T25.deallocate();
#endif
...
# pragma omp task if(sequential26) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S26, T26, M26, steps_left - 1);
#ifndef _PARALLEL_
    S26.deallocate();
    T26.deallocate();
#endif
...
# pragma omp task if(sequential27) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S27, T27, M27, steps_left - 1);
#ifndef _PARALLEL_
    S27.deallocate();
    T27.deallocate();
#endif
...
# pragma omp task if(sequential28) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S28, T28, M28, steps_left - 1);
#ifndef _PARALLEL_
    S28.deallocate();
    T28.deallocate();
#endif
...
# pragma omp task if(sequential29) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S29, T29, M29, steps_left - 1);
#ifndef _PARALLEL_
    S29.deallocate();
    T29.deallocate();
#endif
...
# pragma omp task if(sequential30) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S30, T30, M30, steps_left - 1);
#ifndef _PARALLEL_
    S30.deallocate();
    T30.deallocate();
#endif
...
# pragma omp task if(sequential31) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S31, T31, M31, steps_left - 1);
#ifndef _PARALLEL_
    S31.deallocate();
    T31.deallocate();
#endif
...
# pragma omp task if(sequential32) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S32, T32, M32, steps_left - 1);
#ifndef _PARALLEL_
    S32.deallocate();
    T32.deallocate();
#endif
...
# pragma omp task if(sequential33) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S33, T33, M33, steps_left - 1);
#ifndef _PARALLEL_
    S33.deallocate();
    T33.deallocate();
#endif
...
# pragma omp task if(sequential34) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S34, T34, M34, steps_left - 1);
#ifndef _PARALLEL_
    S34.deallocate();
    T34.deallocate();
#endif
...
# pragma omp task if(sequential35) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S35, T35, M35, steps_left - 1);
#ifndef _PARALLEL_
    S35.deallocate();
    T35.deallocate();
#endif
...
# pragma omp task if(sequential36) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S36, T36, M36, steps_left - 1);
#ifndef _PARALLEL_
    S36.deallocate();
    T36.deallocate();
#endif
...
# pragma omp task if(sequential37) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S37, T37, M37, steps_left - 1);
#ifndef _PARALLEL_
    S37.deallocate();
    T37.deallocate();
#endif
...
# pragma omp task if(sequential38) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S38, T38, M38, steps_left - 1);
#ifndef _PARALLEL_
    S38.deallocate();
    T38.deallocate();
#endif
...
# pragma omp task if(sequential39) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S39, T39, M39, steps_left - 1);
#ifndef _PARALLEL_
    S39.deallocate();
    T39.deallocate();
#endif
...
# pragma omp task if(sequential40) shared(mem_mngr, locker) untied
    ...
    square54_2::FastMatmul(S40, T40, M40, steps_left - 1);
#ifndef _PARALLEL_
    S40.deallocate();
    T40.deallocate();
#endif
