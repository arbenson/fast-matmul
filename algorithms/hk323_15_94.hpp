...
# pragma omp task
    ...
    FastMatmulRecursive(M1A, B21, M1, numsteps - 1, x);
    M1A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(B11, B21, Scalar(1.0), Scalar(-1.0), M2B);
    FastMatmulRecursive(A11, M2B, M2, numsteps - 1, x);
    M2B.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmulRecursive(M3A, B12, M3, numsteps - 1, x);
    M3A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    Add(A11, A12, A31, A32, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), Scalar(1.0), M6A);
...
# pragma omp task
    ...
    Add(A11, A12, A32, Scalar(1.0), Scalar(1.0), Scalar(-1.0), M8A);
    Matrix<Scalar> M8B(B11.m(), B11.n());
    Add(B11, B13, B21, Scalar(-1.0), Scalar(1.0), Scalar(1.0), M8B);
...
# pragma omp task
    ...
    Add(A21, A22, A31, A32, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), Scalar(1.0), M11A);
...
# pragma omp task
    ...
    Add(B12, B13, B22, B23, Scalar(-1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), M13B);
...
# pragma omp task
    ...
    Add(A21, A22, A31, Scalar(-1.0), Scalar(-1.0), Scalar(1.0), M14A);
    Matrix<Scalar> M14B(B11.m(), B11.n());
    Add(B12, B22, B23, Scalar(1.0), Scalar(-1.0), Scalar(1.0), M14B);
...
# pragma omp task
    ...
    Add(B11, B13, B21, B23, Scalar(-1.0), Scalar(1.0), Scalar(1.0), Scalar(-1.0), M15B);
