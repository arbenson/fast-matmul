...
# pragma omp taskwait
    ...
    M_Add1(M3, M5, M6, M13, C11, x, beta);
    M_Add2(M3, M5, M6, M10, C12, x, beta);
    M_Add3(M1, M2, M4, M7, M8, M11, M12, M15, C13, x, beta);
    M_Add4(M6, M8, C21, x, beta);
    M_Add5(M5, M6, M10, M15, C22, x, beta);
    M_Add6(M4, M7, M8, M12, C23, x, beta);
