...
# pragma omp task if(sequential2) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A21, T2, M2, total_steps, steps_left - 1, (start_index + 2 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential4) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A41, T4, M4, total_steps, steps_left - 1, (start_index + 4 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential5) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A12, T5, M5, total_steps, steps_left - 1, (start_index + 5 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential7) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S7, T7, M7, total_steps, steps_left - 1, (start_index + 7 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential8) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S8, T8, M8, total_steps, steps_left - 1, (start_index + 8 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential15) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A21, T15, M15, total_steps, steps_left - 1, (start_index + 15 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential17) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A23, T17, M17, total_steps, steps_left - 1, (start_index + 17 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential20) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S20, T20, M20, total_steps, steps_left - 1, (start_index + 20 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential22) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S22, B32, M22, total_steps, steps_left - 1, (start_index + 22 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential23) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A42, T23, M23, total_steps, steps_left - 1, (start_index + 23 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential24) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S24, B13, M24, total_steps, steps_left - 1, (start_index + 24 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential25) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, A41, T25, M25, total_steps, steps_left - 1, (start_index + 25 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential26) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S26, B31, M26, total_steps, steps_left - 1, (start_index + 26 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential27) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S27, B12, M27, total_steps, steps_left - 1, (start_index + 27 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
...
# pragma omp task if(sequential28) shared(mem_mngr) untied
    ...
    FastMatmulRecursive(mem_mngr, S28, B23, M28, total_steps, steps_left - 1, (start_index + 28 - 1) * 29, x, num_threads, Scalar(0.0));
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
    }
