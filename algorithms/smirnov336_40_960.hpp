...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 1, num_threads)) untied
    ...
    S_Add1(A11, A13, A22, A23, A31, A32, S1, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 2, num_threads)) untied
    ...
    S_Add2(A11, A13, A22, A23, A31, A32, S2, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 3, num_threads)) untied
    ...
    S_Add3(A11, A13, A22, A23, A31, A32, S3, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 4, num_threads)) untied
    ...
    S_Add4(A11, A13, A22, A23, A31, A32, S4, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 5, num_threads)) untied
    ...
    S_Add5(A11, A13, A22, A23, A31, A32, S5, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 6, num_threads)) untied
    ...
    S_Add6(A11, A13, A22, A23, A31, A32, S6, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 7, num_threads)) untied
    ...
    S_Add7(A11, A13, A22, A23, A31, A32, S7, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 8, num_threads)) untied
    ...
    S_Add8(A11, A13, A22, A23, A31, A32, S8, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 9, num_threads)) untied
    ...
    S_Add9(A11, A13, A22, A23, A31, A32, S9, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 10, num_threads)) untied
    ...
    S_Add10(A11, A13, A22, A23, A31, A32, S10, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 11, num_threads)) untied
    ...
    S_Add11(A11, A13, A22, A23, A31, A32, S11, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 12, num_threads)) untied
    ...
    S_Add12(A11, A13, A22, A23, A31, A32, S12, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 13, num_threads)) untied
    ...
    S_Add13(A11, A13, A22, A23, A31, A32, S13, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 14, num_threads)) untied
    ...
    S_Add14(A11, A13, A22, A23, A31, A32, S14, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 15, num_threads)) untied
    ...
    S_Add15(A11, A13, A22, A23, A31, A32, S15, x);
...
# pragma omp task if(should_launch_task(40, total_steps, steps_left, start_index, 16, num_threads)) untied
    ...
    S_Add16(A11, A13, A22, A23, A31, A32, S16, x);
...
# pragma omp taskwait
    ...
    M_Add1(M1, M2, M4, M5, M8, M12, M13, M16, M17, M18, M19, M20, M21, M22, M25, M26, M33, M34, M35, M36, M37, M38, M39, M40, C11, x, beta);
    M_Add2(M1, M4, M6, M8, M10, M11, M13, M15, M18, M20, M23, M24, M25, M26, M27, M28, M29, M30, M31, M32, M33, M35, M36, M39, C12, x, beta);
    M_Add3(M2, M3, M5, M7, M9, M12, M14, M16, M18, M20, M23, M24, M25, M26, M27, M28, M29, M30, M31, M32, M33, M35, M36, M39, C13, x, beta);
    M_Add4(M2, M5, M6, M10, M11, M12, M15, M16, M18, M20, M25, M26, M33, M35, M36, M39, C14, x, beta);
    M_Add5(M3, M6, M7, M9, M10, M11, M14, M15, M17, M18, M19, M20, M21, M22, M25, M26, M33, M34, M35, M36, M37, M38, M39, M40, C15, x, beta);
    M_Add6(M1, M3, M4, M7, M8, M9, M13, M14, M18, M20, M25, M26, M33, M35, M36, M39, C16, x, beta);
    M_Add7(M1, M2, M4, M5, M8, M12, M13, M16, M17, M18, M19, M20, M21, M22, M25, M26, M33, M34, M35, M36, M37, M38, M39, M40, C21, x, beta);
    M_Add8(M2, M3, M5, M7, M9, M12, M14, M16, M17, M19, M21, M22, M34, M37, M38, M40, C22, x, beta);
    M_Add9(M1, M4, M6, M8, M10, M11, M13, M15, M17, M19, M21, M22, M34, M37, M38, M40, C23, x, beta);
    M_Add10(M1, M3, M4, M7, M8, M9, M13, M14, M17, M19, M21, M22, M23, M24, M27, M28, M29, M30, M31, M32, M34, M37, M38, M40, C24, x, beta);
    M_Add11(M3, M6, M7, M9, M10, M11, M14, M15, M17, M18, M19, M20, M21, M22, M25, M26, M33, M34, M35, M36, M37, M38, M39, M40, C25, x, beta);
    M_Add12(M2, M5, M6, M10, M11, M12, M15, M16, M17, M19, M21, M22, M23, M24, M27, M28, M29, M30, M31, M32, M34, M37, M38, M40, C26, x, beta);
    M_Add13(M3, M6, M7, M9, M10, M11, M14, M15, M23, M24, M27, M28, M29, M30, M31, M32, C31, x, beta);
    M_Add14(M1, M4, M6, M8, M10, M11, M13, M15, M18, M20, M23, M24, M25, M26, M27, M28, M29, M30, M31, M32, M33, M35, M36, M39, C32, x, beta);
    M_Add15(M2, M3, M5, M7, M9, M12, M14, M16, M18, M20, M23, M24, M25, M26, M27, M28, M29, M30, M31, M32, M33, M35, M36, M39, C33, x, beta);
    M_Add16(M1, M3, M4, M7, M8, M9, M13, M14, M17, M19, M21, M22, M23, M24, M27, M28, M29, M30, M31, M32, M34, M37, M38, M40, C34, x, beta);
    M_Add17(M1, M2, M4, M5, M8, M12, M13, M16, M23, M24, M27, M28, M29, M30, M31, M32, C35, x, beta);
    M_Add18(M2, M5, M6, M10, M11, M12, M15, M16, M17, M19, M21, M22, M23, M24, M27, M28, M29, M30, M31, M32, M34, M37, M38, M40, C36, x, beta);
