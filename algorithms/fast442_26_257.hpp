...
# pragma omp task
    ...
    FastMatmul(M9A, B12, M9, numsteps - 1, x);
    M9A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmul(M13A, B21, M13, numsteps - 1, x);
    M13A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmul(M14A, B41, M14, numsteps - 1, x);
    M14A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmul(M19A, B31, M19, numsteps - 1, x);
    M19A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
...
# pragma omp task
    ...
    FastMatmul(M23A, B32, M23, numsteps - 1, x);
    M23A.deallocate();
#ifdef _CILK_
    }();
#elif defined _OPEN_MP_
